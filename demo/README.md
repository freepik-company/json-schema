## FPJsonSchema\Validator Demo

This demo script uses the example from the root README.md and provides sample JSON files for testing `FPJsonSchema\Validator`.
